...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | ---: | --- |
| paper_a_core7_att_mediation | PE,EE,SI,FC,ATT,BI,UB | 21 | 21 | 0 | 0 | 10 | 71 | 3 | failed | not_run | 0.3186 | Primary feasible ATT mediation route if TSSEM converges. |
| paper_a_trust6_mechanism | PE,EE,SI,TRU,BI,UB | 15 | 15 | 0 | 0 | 8 | 72 | 6 | failed | not_run | 0.3195 | AI-specific TRU mechanism route; SI path should be sensitivity if unstable. |
| paper_a_full10_theory_target | PE,EE,SI,FC,ATT,SE,TRU,ANX,BI,UB | 45 | 44 | 1 | 1 | 1 | 74 | 0 | failed | not_run | NA | Full 10-construct theory target; expected to be sparse and must not be overclaimed if estimation fails. |
