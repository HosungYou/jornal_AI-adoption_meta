...
Status: high-confidence Phase 1 Step 4 reference-draft sub-batch generated. This is not a frozen full-corpus reference and does not start Step 5.
...
| Item | Count |
|---|---:|
| Row-level draft records | 59 |
| Included studies with full row-set drafts | 5 |
| Included studies with partial value-decision drafts | 3 |
| Logged exclusions carried to status draft | 3 |
| Studies held for reconciliation | 1 |
...
- S191 remains held because the decision log says to use R2 Table 2 values, but the current combined derived long table lacks S191 R2 correlation rows.
...
2. Carry the six confirmed Phase 2 exclusions into the full-corpus audit layer.
3. Apply explicit Phase 1 rule-decision row filters/source audits for the 12 remaining rule-decision studies.
4. Run source-value audit for S086 and S168.
5. Triage the 124 remaining correlation-disagreement studies.
