...
Input: `data/04_extraction/05_llm_masem_substitution/results/paper_a_anx_tru_rescue_after_source_correction_20260614/paper_a_source_corrected_plus_anx_tru_diagnostic_input_20260614.csv`
...
| paper_a_full10_theory_target | PE,EE,SI,FC,ATT,SE,TRU,ANX,BI,UB | 45 | 45 | 0 | 1 | 1 | 77 | 0 | failed | not_run | -0.0102 | Full 10-construct theory target; expected to be sparse and must not be overclaimed if estimation fails. |
