...
| 3 | Source-document adjudication | Pairwise differences are available | Every discrepancy has a source-anchored decision and rationale | Paper1/Paper2 blocker studies resolved into tiered decisions for the 2026-06-05 freeze packet |
| 4 | Reference standard freeze | Adjudication is complete | Frozen reference file and freeze log are committed | Tiered source-anchored reference layer created 2026-06-05 |
