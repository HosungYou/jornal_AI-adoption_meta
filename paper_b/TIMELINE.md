...
| 3 | Calibration session (R1+R2+R3, pilot 10개) | R1, R2, R3 | Pilot IRR | 📘📗 |
...
| Day | 작업 | 담당 | Pace | 범위 |
|-----|------|------|------|------|
| 1-5 | 100 studies 독립 코딩 | R2 | 20/day | 📘📗 |
| 1-5 | 100 studies 독립 코딩 | R3 | 20/day | 📘📗 |

**Daily target**: 각자 20 studies/day × 5 days = 100 studies
**예상 소요**: ~30-45 min/study × 20 = 10-15 hours/day (intensive)
**핵심**: R2, R3 모두 AI output에 blinded 상태 유지. R1(PI)은 adjudicator로 대기.

## Week 3: Phase 1 — IRR + Gold Standard 📘📗

| Day | 작업 | 담당 | 산출물 | 범위 |
|-----|------|------|--------|------|
| 1-2 | 코딩 완료 + 제출 | R2, R3 | coder_r2/, coder_r3/ | 📘📗 |
| 2-3 | **Unblinding**: IRR 계산 (R2 vs R3) | R1 | irr_results.csv | 📘 |
| 3-4 | Discrepancy identification | R1 | discrepancy_log.csv | 📘📗 |
| 4-5 | Discrepancy resolution (R1 adjudication) | R1, R2, R3 | resolved values | 📘📗 |
...
| Day | 작업 | 담당 | 산출물 | 범위 |
|-----|------|------|--------|------|
| 1 | AI consensus 계산 (100 studies) | R1 | consensus_100.csv | 📘 |
| 1-2 | RQ1-4 분석 실행 | R1 | model_accuracy.csv 등 | 📘 |
| 3-5 | AI consensus 검증 (~200 studies) | R1 | ~100 studies | 📗 |
| 3-5 | AI consensus 검증 (~200 studies) | R2 | ~100 studies | 📗 |
...
| Day | 작업 | 담당 | 산출물 | 범위 |
|-----|------|------|--------|------|
| 1-2 | Phase 2 verification 완료 | R1, R2 | verified_data_phase2.csv | 📗 |
| 1-2 | Paper B Tables 5-10 채우기 | R1 | Results section | 📘 |
| 2-3 | Figures 생성 (heatmap, Bland-Altman) | R1 | figures/ | 📘 |
| 3-4 | R3: 10% spot-check (~20 studies) | R3 | qa_spotcheck.csv | 📗 |
| 4-5 | QA gates 확인 | R1 | qa_report.md | 📗 |
