...
- Freeze date and commit hash.
- Source file list and excluded private/raw files.
- Discrepancy resolution log.
- Field-level decision rules applied during adjudication.
- Any post-freeze corrections, each with date, reason, and reviewer.
